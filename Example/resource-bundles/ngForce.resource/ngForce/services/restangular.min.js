(function () {
  ...
  module.provider('Restangular', function () {
    ...
    Configurer.init = function (object, config) {
      ...
      config.fullRequestInterceptor = config.fullRequestInterceptor || function (element, operation, path, url, headers, params, httpConfig) {
        return {
          element: element,
          headers: headers,
          params: params,
      ...
      BaseCreator.prototype.resource = function (current, $http, localHttpConfig, callHeaders, callParams, what, etag, operation) {
        ...
        if (this.config.suffix && url.indexOf(this.config.suffix, url.length - this.config.suffix.length) === -1) {
      ...
      function ($http, $q) {
        function createServiceForConfiguration(config) {
          ...
          function fetchFunction(what, reqParams, headers) {
            ...
            urlHandler.resource(this, $http, request.httpConfig, request.headers, request.params, what, this[config.restangularFields.etag], operation).getList().then(function (response) {
